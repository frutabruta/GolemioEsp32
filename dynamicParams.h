...
char golemioParametry [MAX_GOLEMIO_PARAMETRY_LEN+1]= "?minutesBefore=1&minutesAfter=360&limit=1&mode=departures&filter=none&order=real&skip=canceled&aswIds=548_2";
